...
},
{
  ...
  nodes: {
    ...
    during: { text: ["Any luck with the survey?",
      ...
      choices: [
        { t: "I’ve got one for you.", to: 'got', if: () => (G.todayStats.satisfied || 0) >= 2 || G.totals.satisfied >= 3 },
        { t: "Not yet.", to: null }] },
    got: { text: ["Go on.", "...",
...
},
{
  ...
  entry() {
    ...
    return G.flags.metMarcus ? 'again' : 'first';
  },
  nodes: {
    ...
    sadyes: { text: ["It's fine. It's a nice card.", "...", "It is a bit sad, yeah."],
      do() { Rel.add('marcus', 2); Player.xp(20); if (!Q.active('q_marcus') && !Q.complete2('q_marcus')) Q.start('q_marcus'); }, to: null },
    actually: { text: ["No.", "It's in March. The card's always in October.",
      ...
      do() { Rel.add('marcus', 3); Player.xp(35); G.flags.marcusDate = true; if (!Q.active('q_marcus') && !Q.complete2('q_marcus')) Q.start('q_marcus'); Ach.get('a_marcus'); }, to: null },
