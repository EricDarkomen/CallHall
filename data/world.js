...
const ZONES = {
  ...
  manage:   { name: 'Management Floor', floor: '#3d2b2e', alt: '#372629', wall: '#25181a', tint: '#ff5f56'  , tile: 'floor.carpet.red', wtile: 'wall.drywall' },
  toilet:   { name: 'The Toilets',      floor: '#26363f', alt: '#223039', wall: '#151f26', tint: '#4da3ff', surf: 'tile', wsurf: 'tile'  , tile: 'floor.tile' },
...
const FURN = {
  ...
  table: { drawn: true }, loo: { size: 21, art: 'loo' },
