...
const LEVELS = {
  ...
  town: {
    ...
    surfaces: [
      ...
      /* The retail park and the way into it — and the way in is TARMAC ALL THE
         WAY TO THE CARRIAGEWAY, which it was not. It ran from row 42 and
         Corven Way's carriageway stops at row 39, so two rows of footway lay
         across the entrance: R.kerbs() found a boundary there and drew a
         six-inch kerb across the one gap forty cars a day drive through, and
         a flood fill of this level's carriageway came back with the whole
         retail park as a piece of road reachable from no other piece of road.
         The same fault three other notes in this list warn about — see the
         crossover out of the car park above, the drive-thru lane and the car
         wash apron — and the only one of the four that had it. */
      { s: 'tarmac', r: [34, 40, 37, 42] },
    ...
    cars: [
      ...
      { x: 44, y: 15.7, face: 'e', model: 'estate', body: '#9ba1a8',
      ...
      { x: 22, y: 44.5, face: 'n', model: 'hatch', body: '#2f4a3a', name: 'A green hatchback', use: 'someoneElsesCar' },
      { x: 28, y: 44.5, face: 'n', model: 'small', name: 'A small blue car', use: 'someoneElsesCar' },
      { x: 42, y: 44.5, face: 'n', model: 'estate', body: '#6d6f74', name: 'A grey estate', use: 'someoneElsesCar' },
      { x: 48, y: 44.5, face: 'n', model: 'saloon', body: '#8a2f34', name: 'A red saloon', use: 'someoneElsesCar' },
      ...
      { model: 'saloon', body: '#2f3d5a', name: 'A car, passing', use: 'passingCar', traffic: true, cruise: 135, leg: 2, along: 20,
        route: [[61.5, 17.5], [106.5, 17.5], [106.5, 38.5], [61.5, 38.5]] },
      /* The long way round: Fenn Street, Marlow, Corven Way, Aldergate. */
      { model: 'small', body: '#7a5f2f', name: 'A car, passing', use: 'passingCar', traffic: true, cruise: 145, leg: 1, along: 6,
      ...
      { model: 'small', body: '#d8d5cc', name: 'A driving school car', use: 'learner', traffic: true, cruise: 78, leg: 3, along: 22,
        route: [[9.5, 35.5], [106.5, 35.5], [106.5, 56.5], [9.5, 56.5]] },
      ...
      { model: 'bus', body: '#2f5d43', name: 'The 41', use: 'theFortyOne',
      ...
      { x: 60, y: 111, face: 'n', model: 'hatch', body: '#2d3f52', name: 'A blue hatchback', use: 'someoneElsesCar' },
      { x: 64, y: 111, face: 'n', model: 'small', name: 'A small blue car', use: 'someoneElsesCar' },
      { x: 70, y: 111, face: 'n', model: 'estate', body: '#57624f', name: 'An olive estate', use: 'someoneElsesCar' },
      { x: 76, y: 111, face: 'n', model: 'van', body: '#7b4f3a', name: 'The chandler’s van', use: 'chandlerVan' },
      /* On the double yellows outside the North Gate, on its hazards, with
         ...
         what it is. */
      { x: 52, y: 76.5, face: 'e', model: 'van', body: '#d8d5cc',
      ...
      { x: 4, y: 16.5, face: 'e', model: 'saloon', body: '#8a2f34', name: 'A red saloon', use: 'parkedCar' },
      { x: 13, y: 16.5, face: 'w', model: 'hatch', body: '#2d3f52', name: 'A blue hatchback', use: 'parkedCar' },
      { x: 16, y: 21.5, face: 'e', model: 'hatch', body: '#6b3350', name: 'A plum hatchback', use: 'parkedCar' },
      { x: 54, y: 21.5, face: 'e', model: 'estate', body: '#57624f', name: 'An olive estate', use: 'parkedCar' },
      ...
      { x: 89, y: 21.5, face: 'w', model: 'van', body: '#d8d5cc', name: 'A white van on the zig-zags', use: 'zigzagVan' },
      { x: 34, y: 34.5, face: 'e', model: 'small', body: '#7d6a4f', name: 'A beige runabout', use: 'parkedCar' },
      { x: 68, y: 34.5, face: 'e', model: 'saloon', body: '#8a2f34', name: 'A red saloon', use: 'parkedCar' },
      ...
      { x: 50, y: 39.5, face: 'e', model: 'estate', body: '#57624f', name: 'An olive estate', use: 'parkedCar' },
      { x: 86, y: 39.5, face: 'e', model: 'small', name: 'A small blue car', use: 'parkedCar' },
      { x: 34, y: 52.5, face: 'e', model: 'small', body: '#7d6a4f', name: 'A beige runabout', use: 'parkedCar' },
      { x: 43, y: 52.5, face: 'w', model: 'hatch', body: '#2f4a3a', name: 'A green hatchback', use: 'parkedCar' },
      { x: 68, y: 52.5, face: 'e', model: 'saloon', body: '#8a2f34', name: 'A red saloon', use: 'parkedCar' },
      { x: 10, y: 57.5, face: 'e', model: 'hatch', body: '#6b3350', name: 'A plum hatchback', use: 'parkedCar' },
      { x: 52, y: 57.5, face: 'e', model: 'estate', body: '#57624f', name: 'An olive estate', use: 'parkedCar' },
      { x: 82, y: 57.5, face: 'e', model: 'small', name: 'A small blue car', use: 'parkedCar' },
      { x: 52, y: 71.5, face: 'e', model: 'small', body: '#7d6a4f', name: 'A beige runabout', use: 'parkedCar' },
      { x: 94, y: 71.5, face: 'e', model: 'saloon', body: '#8a2f34', name: 'A red saloon', use: 'parkedCar' },
      { x: 36, y: 76.5, face: 'e', model: 'hatch', body: '#6b3350', name: 'A plum hatchback', use: 'parkedCar' },
      { x: 70, y: 76.5, face: 'e', model: 'estate', body: '#57624f', name: 'An olive estate', use: 'parkedCar' },
      { x: 18, y: 98.5, face: 'e', model: 'small', name: 'A small blue car', use: 'parkedCar' },
      { x: 27, y: 98.5, face: 'w', model: 'van', body: '#d8d5cc', name: 'A white van', use: 'parkedCar' },
      { x: 60, y: 98.5, face: 'e', model: 'small', body: '#7d6a4f', name: 'A beige runabout', use: 'parkedCar' },
      { x: 46, y: 103.5, face: 'e', model: 'hatch', body: '#6b3350', name: 'A plum hatchback', use: 'parkedCar' },
      { x: 55, y: 103.5, face: 'w', model: 'saloon', body: '#3b3f48', name: 'A grey saloon', use: 'parkedCar' },
      { x: 82, y: 103.5, face: 'e', model: 'estate', body: '#57624f', name: 'An olive estate', use: 'parkedCar' },
      ...
      /* ---- TRAFFIC, SOUTH ----
         ...
         the other. */
      { model: 'saloon', body: '#4a4f58', name: 'A car, passing', use: 'passingCar', traffic: true, cruise: 148, leg: 0, along: 24,
        route: [[11.5, 72.5], [106.5, 72.5], [106.5, 102.5], [11.5, 102.5]] },
      { model: 'small', body: '#8a6a3a', name: 'A car, passing', use: 'passingCar', traffic: true, cruise: 138, leg: 1, along: 12,
      ...
      { model: 'bus', body: '#7e3b3f', name: 'The 12', use: 'theTwelve',
