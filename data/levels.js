  ...
  office: {
    ...
    furnish() {
      ...
      rows.forEach(y => cols.forEach(x => {
        ...
        A({ x, y: y + 1, e: '🪑', name: 'Chair', kind: 'chair', solid: false, use: 'chair', deskId: 'd' + n });
      ...
      A({ x: 12, y: 22, e: '📺', name: 'Break room television', kind: 'tv', solid: true, use: 'breakTV' });
      ...
      A({ x: 54, y: 24, e: '🪞', name: 'Mirror', kind: 'mirror', solid: true, use: 'mirror' });
