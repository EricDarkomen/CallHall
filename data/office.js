...
const TEXT_SCRIPT = [
  { t: 543, who: 'Mum', f: '👩‍🦳', m: 'Did you get there alright? Text me when you’re in.' },
  { t: 556, who: 'Jamie', f: '🧑', m: 'how’s the new job' },
  { t: 558, who: 'Jamie', f: '🧑', m: 'don’t answer that youre at work' },
  { t: 572, who: 'Mum', f: '👩‍🦳', m: 'I’ve put a lasagne in the freezer for you. The little one, not the big one. The big one is for Sunday.' },
  { t: 594, who: 'Unknown number', f: '📵', m: 'Hi! Sorry to bother you — is this the number for the printer? Somebody at your work gave it to me.' },
  { t: 618, who: 'Lettings', f: '🏠', m: 'Hi, re: the boiler — the engineer can do Tuesday between 8 and 6. Please confirm.' },
  { t: 652, who: 'Jamie', f: '🧑', m: 'pub thursday? saying pub but its the one with the quiz' },
  { t: 668, who: 'Dentist', f: '🦷', m: 'REMINDER: appointment Thu 09:30. Reply CANCEL to cancel. You will not be offered another one until March.' },
  { t: 690, who: 'Mum', f: '👩‍🦳', m: 'Is it a phone job? Your uncle did a phone job. He said the trick is you stop hearing them after a bit.' },
  { t: 714, who: 'Lettings', f: '🏠', m: 'Between 8 and 6 is the window. We cannot narrow the window. The window is the window.' },
  { t: 748, who: 'Jamie', f: '🧑', m: 'someone at my work also has a colin' },
  { t: 782, who: 'Delivery', f: '📦', m: 'Your parcel was left in a SAFE PLACE. Photo attached. The photo is of a hedge.' },
  { t: 806, who: 'Mum', f: '👩‍🦳', m: 'Don’t let them put on you. You’re allowed a lunch. It’s the law. Your father looked it up.' },
  { t: 838, who: 'Unknown number', f: '📵', m: 'sorry to text again. is there any update on the printer' },
  { t: 872, who: 'Jamie', f: '🧑', m: 'quiz is actually wednesday. i have been informed' },
  { t: 918, who: 'Lettings', f: '🏠', m: 'The engineer attended. Nobody was in. This will be recorded as a missed appointment.' },
  { t: 956, who: 'Mum', f: '👩‍🦳', m: 'Nearly done? Put the heating on when you get in, don’t sit there in a coat like last time.' },
  { t: 1004, who: 'Jamie', f: '🧑', m: 'you off yet' },
  { t: 1032, who: 'Jamie', f: '🧑', m: 'youre still there arent you' },
  { t: 1068, who: 'Mum', f: '👩‍🦳', m: 'The little one is 40 minutes from frozen. Not the big one. Please read the label.' }
];
...
const CUT = [
  ...
  { k: 'scene', f: '🚪', l: 'Reception · 08:58', cam: [15, 15], len: 2.4,
  ...
  { k: 'line', f: '💂', l: 'Big Ron · Security', cam: [15, 8], len: 1.4, t: '“First day?”' },
  { k: 'line', f: '🧑', l: 'You', cam: [15, 11], len: 1.1, t: '“Yeah.”' },
  { k: 'line', f: '💂', l: 'Big Ron · Security', cam: [15, 8], len: 1.1, t: '“Sorry.”' },
  { k: 'line', f: '💂', l: 'Big Ron · Security', cam: [14, 8], len: 2.2,
    t: '“Fourth floor. The lift is decorative. Take the stairs and keep going up until it gets louder.”' },
  { k: 'scene', f: '📋', l: 'The induction pack', cam: [6, 10], len: 2.6,
  ...
  { k: 'scene', f: '🧯', level: 'office', l: 'The stairs', cam: [17, 39], len: 3.0,
  ...
  { k: 'scene', f: '🕰️', level: 'ground', l: 'Reception · 08:59', cam: [15, 11], len: 3.6,
  ...
  { k: 'title', f: '🧑‍💻', l: 'Nine o’clock', cam: [15, 11], len: 2.6, t: 'SURVIVE THE SHIFT.' }
];
