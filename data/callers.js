...
const INBOUND = [
  { id: 'formal', ch: 'mail', w: 14, face: '📄',
    from: 'Mr D. Hollis <complaints.hollis@outlook.com>',
    subj: 'FORMAL COMPLAINT — reference 000/ACC/HOLLIS (2nd attempt)',
    body: 'To whom it may concern,\n\nI refer to my telephone conversation of the 4th, my email of the 6th, my email of the 9th, and my email of the 11th, to which I have received an automated acknowledgement and nothing else.\n\nI am now putting this in writing so that there is a record. I have kept a record. I have kept a record of keeping the record.\n\nI would like: (1) an explanation, (2) an apology, and (3) confirmation in writing that this will not recur. I would like them in that order.\n\nI am not an unreasonable man.\n\nYours faithfully,\nD. Hollis (Mr)',
    name: 'MR D. HOLLIS (MR)', issue: 'Re: FORMAL COMPLAINT — 2nd attempt',
    frus: 92, agg: 5, pat: 170,
    lines: {
      open: ['I have received your reply. I note that it does not address points two or three.'],
      mid: ['I have printed this thread. It is eleven pages.',
        'Please do not send me the link again. I have been to the link.',
        'I am copying in nobody at this stage. I want that noted as a courtesy.',
        'You have used the phrase “going forward”. I would like to talk about what has already happened.'],
      hot: ['I will be taking this further. I have not yet decided how far, which I appreciate weakens the sentence.',
        'I am a member of a forum on which this company is discussed.'],
      win: ['Thank you. That is an explanation, an apology, and it is in writing.\n\nI will consider the matter closed.\n\nYou have been the first person to answer the actual question. I am sorry it took eleven pages.\n\nD. Hollis (Mr)'] } },

  { id: 'allstaff', ch: 'mail', w: 11, face: '📢',
    from: 'Colin <synergy@callhall.co.uk>',
    subj: 'RE: RE: FW: RE: quick alignment on the printer piece',
    body: 'Hi,\n\nCircling back on this.\n\nSounds like there’s an opportunity to align on the printer piece before it becomes a thing. I’ve had a think and I’ve got a deck.\n\nNo pressure at all — just conscious of the optics.\n\nSent to: All Staff (612 recipients)\n\nColin',
    name: 'COLIN (ALL STAFF, 612)', issue: 'Re: quick alignment on the printer piece',
    frus: 70, agg: 4, pat: 200,
    lines: {
      open: ['Thanks for coming back to me. Reply-all is fine — good for visibility.'],
      mid: ['Just conscious of time on this one, so I’ll keep it brief. (14 paragraphs follow.)',
        'To be clear, I’m not saying that. I’m saying the opposite of that, but warmly.',
        'Have we got a single source of truth on the printer?',
        'Looping in a few more people for awareness. And a few for awareness of the awareness.'],
      hot: ['I think we’re talking past each other, which is on both of us, and mostly you.',
        'I’ll put thirty minutes in. I’ll put it in for 08:30. It will recur.'],
      win: ['Great — really helpful, thank you.\n\nI’ll take that as aligned and drop the deck.\n\nOne small note: 612 people have now watched us do this. Several have replied “+1”.\n\nColin'] } },

  { id: 'form', ch: 'mail', w: 10, face: '🕓',
    from: 'webform@callhall.co.uk (on behalf of a customer)',
    subj: 'Website enquiry — submitted 02:47',
    body: 'A customer has submitted the enquiry form.\n\nNAME: (left blank)\nACCOUNT: (left blank)\nPREFERRED CONTACT: “not the phone”\nSUBJECT: it’s happening again\n\nMESSAGE:\nit’s happening again. i know you’ll say it isn’t but it is. i’m not going to ring because last time i rang i was on for an hour and a half and then it went dead and i had to go to work.\n\ni’m typing this at ten to three in the morning because it’s happening now. if you read this in the morning it will have stopped and you’ll tell me nothing happened.\n\nsomething happened.\n\nThis message was submitted outside business hours and has been held for 6 hours.',
    name: 'A FORM, SUBMITTED AT 02:47', issue: 'Re: it’s happening again',
    frus: 66, agg: 6, pat: 140,
    lines: {
      open: ['oh. hello. i didn’t think anyone actually read these.'],
      mid: ['it’s stopped now. i knew it would stop.',
        'i’m not being awkward about the phone. i just can’t do another hour and a half.',
        'do you want me to write down what it does? i’ve been writing it down.',
        'sorry for the caps in the form. i was tired.'],
      hot: ['you’re going to close this, aren’t you. it’s fine. i’ll fill the form in again tomorrow.',
        'nobody’s ever put a note on it. i’ve asked four times for a note on it.'],
      win: ['right. so there IS a note on it now.\n\nand you believed me, which — i’ll be honest — i’d stopped expecting.\n\nif it does it again i’ll fill the form in and say “see the note”. that’s all i wanted. thank you.'] } },

  { id: 'ryan', ch: 'text', w: 13, face: '📵',
    from: 'Unknown number',
    subj: 'is that the lad from callhall',
    body: 'is that the lad from callhall\n\na fella called ryan gave me this number and said text if it happens again\n\nits happened again',
    name: 'SOMEBODY RYAN GAVE YOUR NUMBER TO', issue: 'Re: a fella called Ryan',
    frus: 74, agg: 7, pat: 110,
    lines: {
      open: ['ryan said you’d sort it. ryan said you were the good one'],
      mid: ['im not being funny but ryan said', 'do you want a photo of it', 'thats the same thing ryan said',
        'im not going through the menu again. the menu asked me to say why im calling and i did say and it said sorry i didnt catch that'],
      hot: ['is ryan there', 'has ryan left', 'right so nobody knows a ryan'],
      win: ['nice one. thats sorted then\n\nyoure better than ryan\n\nno disrespect to ryan'] } },

  { id: 'review', ch: 'text', w: 11, face: '⭐',
    from: 'Caller Who Has Already Posted About You',
    subj: 'left you a review. one star. happy to amend',
    body: 'hiya — left you a review. one star. up to 47 likes\n\nhappy to amend it if this gets sorted today. no pressure!! 🙂',
    name: 'CALLER WHO HAS ALREADY POSTED ABOUT YOU', issue: 'Re: one star, happy to amend',
    frus: 88, agg: 9, pat: 95,
    lines: {
      open: ['just so you know its at 61 likes now. somebody in the replies has said “same”'],
      mid: ['not a threat!! just keeping you in the loop 🙂', 'somebody has replied with a photo of their own bill',
        'ive been asked to go on the local radio about it. ive said id think about it',
        'im not one of these people who complains'],
      hot: ['ive drafted a follow up post. i wont post it. i might post it',
        'the local paper has a page for this'],
      win: ['amended!! five stars 🙂\n\nive said “spoke to a lovely person who actually explained it”\n\nthe post about the boiler stays up though. thats a different company'] } },

  { id: 'nightshift', ch: 'text', w: 8, face: '🌙',
    from: 'Priya (SME)',
    subj: 'you awake? wrong question. you at your desk?',
    body: 'you awake? wrong question. you at your desk?\n\nsomething’s come in on the overnight queue with your name on it. not your fault — your name’s on it because you took the first one.\n\nit needs answering by a person and everyone else is on a call. no rush. slight rush.',
    name: 'THE OVERNIGHT QUEUE, WITH YOUR NAME ON IT', issue: 'Re: something’s come in',
    frus: 58, agg: 6, pat: 130,
    lines: {
      open: ['right. it’s one of the 2009 ones. the formulas have been wrong since 2009, which you know, because everyone knows.'],
      mid: ['don’t put “as per my last message”. we’re better than that.',
        'i can give you the history but the history is four years long and mostly Terry.',
        'if you say “system” they’ll ask which system. there are nine.',
        'you’re doing the thing where you apologise first. it’s fine. it’s also a tell.'],
      hot: ['careful. that reads like a no, and a no in writing goes in a folder.',
        'that’s the sentence that gets quoted back at you in March.'],
      win: ['that’ll do it. that’s the right answer and it’s the right answer in writing, which is rarer.\n\ni’ve put a note on it. a real one.\n\ngo home. p'] } }
];
